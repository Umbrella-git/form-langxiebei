			...
			<view class="example">
				...
				<uni-forms ref="baseForm" :modelValue="baseFormData">
					...
					<uni-forms-item label="日期时间">
						<uni-datetime-picker type="date" return-type="timestamp" v-model="baseFormData.datetimesingle"/>
					</uni-forms-item>
				</uni-forms>
			</view>
		</uni-section>
...
<script>
	export default {
		...
		methods: {
			asyncPng(Params){
				this.baseFormData.tempFilePaths=Params.tempFilePaths[0]
				console.log(Params)
			},
			onClickItem(e) {
				console.log(e);
			...
			submit(ref) {
				console.log('success', this.baseFormData);
